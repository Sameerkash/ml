...
#heartDisease = pd.read_csv('7heart_disease_data.csv')

data=pd.read_csv("7heart_disease_data.csv", names=['age','Gender','Family','diet','Lifestyle','cholestrol','heartdisease'])
